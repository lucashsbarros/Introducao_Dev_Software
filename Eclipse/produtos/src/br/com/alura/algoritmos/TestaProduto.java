...
public class TestaProduto {
	public static void main(String[] args) {
		...
		//caso uma linguagem não souber o tamanho de um array, pode utlizar esse código abaixo.
		// Repare que com esse código é aceito os campos NULL
	...
	private static int buscaMenor(Produto[] produtos, int inicio, int termino) {
		...
		// FUNÇÃO QUE PODE SER UTILIZADA NO JAVA
